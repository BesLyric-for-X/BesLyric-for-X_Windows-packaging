...
var
    global_boolean_CancelWithoutPrompt: Boolean; // Does bypass the prompt of exit installer.
...
// CurStepChanged(CurStep: TSetupStep) will be called with
...
begin
    case (CurStep) of
        ssInstall:
        begin
            // HKLM32 and HKCU (in our case, HKCU includes HKCU32 and HKCU64).
